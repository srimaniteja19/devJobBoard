...
function inputCls(error?: { message?: string } | null) {
    ...
    >
      <div className="flex max-h-[90vh] w-full flex-col border-t border-edge bg-surface sm:max-h-none sm:max-w-lg sm:border">
        <div className="flex shrink-0 items-center justify-between border-b border-edge px-4 py-3 sm:px-5 sm:py-4">
          <h2 className="text-[14px] font-medium text-t-primary">Edit Application</h2>
          <button
            type="button"
            onClick={onClose}
            className="p-1 text-t-faint transition-theme hover:text-t-primary"
            aria-label="Close"
          >
            <X className="h-5 w-5" />
          </button>
        ...
        >
          {serverError && (
            <p className="border border-[#3a1a1a] bg-[#1a0f0f] px-3 py-2 text-[12px] text-[#f87171]">
              {serverError}
            </p>
          )}
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <Field label="Applied date">
              <input type="date" {...register("appliedAt")} className={inputCls()} />
            </Field>
          </div>
          ...
          <div className="flex justify-end gap-2 border-t border-edge pt-4">
            <button
              type="button"
              onClick={onClose}
              className="press px-4 py-2 text-[13px] font-light text-t-muted transition-theme hover:text-t-primary"
            >
              Cancel
            </button>
            <button
