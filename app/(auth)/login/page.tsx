    ...
    <div className="w-full max-w-md space-y-6 border border-edge bg-surface p-8">
      ...
      <form onSubmit={handleCredentials} className="space-y-3">
        ...
        <button
          type="submit"
          disabled={loading}
          className="press flex w-full items-center justify-center gap-2 bg-accent px-4 py-2.5 text-[13px] font-medium text-bg transition-theme hover:bg-accent-hover disabled:opacity-50"
        >
          {loading ? (
      ...
      <p className="text-center text-[11px] text-t-faint">
        Dev login &mdash; no password required for testing
      </p>
    </div>
  );
}
